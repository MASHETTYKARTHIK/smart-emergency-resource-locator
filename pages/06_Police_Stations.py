...
st.markdown(f"""
    <div class="hero-section" style="padding: 25px; margin-bottom: 25px;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div>
                <div style="color: #F8FAFC; font-size: 1.2rem; font-weight: 700;">Public Safety & Law</div>
                <div style="color: #94A3B8; font-size: 0.9rem;">Police stations and patrol units across the city.</div>
            </div>
