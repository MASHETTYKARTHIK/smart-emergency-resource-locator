...
with st.container():
    ...
    with col1:
        st.markdown(
            '<div style="padding-top: 10px; color: #94A3B8; font-weight: 600; font-size: 0.8rem;">FILTER VIEW</div>',
            unsafe_allow_html=True,
        )
...
# Map Container
st.markdown(
    '<div style="margin-top: 20px; border-radius: 24px; overflow: hidden; border: 1px solid rgba(255, 255, 255, 0.05); box-shadow: 0 20px 50px rgba(0,0,0,0.4);">',
    unsafe_allow_html=True,
)
m = folium.Map(
