...
st.markdown(
    ...
    <div class="hero-section" style="padding: 25px; margin-bottom: 25px;">
        <div style="display: flex; justify-content: space-between; align-items: center;">
            <div>
                <div style="color: #F8FAFC; font-size: 1.2rem; font-weight: 700;">Blood Supply Network</div>
                <div style="color: #94A3B8; font-size: 0.9rem;">Monitor availability and locations of blood banks.</div>
            </div>
