...
if "fire_search_location" not in st.session_state:
    st.session_state.fire_search_location = ""

if "fire_search_lat" not in st.session_state:
    st.session_state.fire_search_lat = None

if "fire_search_lng" not in st.session_state:
    st.session_state.fire_search_lng = None
        ...
        try:
            ...
            if nom_data:
                ...
                if elements:
                    ...
                    st.session_state.fire_search_results = results
                    st.session_state.fire_search_location = location_query
...
if (
    not search_btn
    and st.session_state.fire_search_results
    and st.session_state.fire_search_location
):
    render_fire_search_results(
        st.session_state.fire_search_results,
        st.session_state.fire_search_location,
        st.session_state.fire_search_lat,
        st.session_state.fire_search_lng,
    )
