...
st.set_page_config(page_title=t["police_stations"], layout="wide")
...
st.info(t["police_emergency_info"])
...
if "police_search_results" not in st.session_state:
    st.session_state.police_search_results = None

if "police_search_location" not in st.session_state:
    st.session_state.police_search_location = ""

if "police_search_lat" not in st.session_state:
    st.session_state.police_search_lat = None

if "police_search_lng" not in st.session_state:
    st.session_state.police_search_lng = None


def render_police_search_results(results, location_query, lat, lng):
    st.success(
        ...
        try:
            ...
            if nom_data:
                ...
                if elements:
                    ...
                    st.session_state.police_search_results = results
                    st.session_state.police_search_location = location_query
                    st.session_state.police_search_lat = lat
                    st.session_state.police_search_lng = lng
...
if (
    not search_btn
    and st.session_state.police_search_results
    and st.session_state.police_search_location
):
    render_police_search_results(
        st.session_state.police_search_results,
        st.session_state.police_search_location,
        st.session_state.police_search_lat,
        st.session_state.police_search_lng,
    )
